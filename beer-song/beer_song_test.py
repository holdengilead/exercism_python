...
class BeerSongTest(unittest.TestCase):
    def test_first_generic_verse(self) -> None:
        expected = [
    ...
    def test_last_generic_verse(self) -> None:
        expected = [
    ...
    def test_verse_with_2_bottles(self) -> None:
        expected = [
    ...
    def test_verse_with_1_bottle(self) -> None:
        expected = [
    ...
    def test_verse_with_0_bottles(self) -> None:
        expected = [
    ...
    def test_first_two_verses(self) -> None:
        expected = [
            "99 bottles of beer on the wall, 99 bottles of beer.",
            "Take one down and pass it around, 98 bottles of beer on the wall.",
            "",
    ...
    def test_last_three_verses(self) -> None:
        expected = [
            "2 bottles of beer on the wall, 2 bottles of beer.",
            "Take one down and pass it around, 1 bottle of beer on the wall.",
            "",
