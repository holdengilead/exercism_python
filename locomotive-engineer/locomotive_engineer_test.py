...
class LocomotiveEngineerTest(unittest.TestCase):
    ...
    def test_get_list_of_wagons(self) -> None:
        input_data = [
            (1, 5, 2, 7, 4),
            (1, 5),
            (1,),
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Expected: {output_data} but got a different wagon list instead."
                )
                self.assertEqual(
    ...
    def test_fix_list_of_wagons(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertEqual(
                    fix_list_of_wagons(input_data[0], input_data[1]),
                    output_data,
                    msg=error_msg,
                )
    ...
    def test_add_missing_stops(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                error_msg = (
                    f"Expected: {output_data} but got a different set of stops instead."
                )
                self.assertEqual(
                    add_missing_stops(input_data[0], **input_data[1]),
                    output_data,
                    msg=error_msg,
                )
    ...
    def test_extend_route_information(self):
        ...
        for variant, (input_data, output_data) in enumerate(
            ...
            with self.subTest(
                ...
                self.assertEqual(
                    extend_route_information(input_data[0], input_data[1]),
                    output_data,
                    msg=error_msg,
                )
